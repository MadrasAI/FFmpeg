/*
 * AArch64 NEON optimised VP3 DSP functions
...
void ff_vp3_v_loop_filter_neon(uint8_t *src, ptrdiff_t stride, int *bounding_values);
void ff_vp3_h_loop_filter_neon(uint8_t *src, ptrdiff_t stride, int *bounding_values);

av_cold void ff_vp3dsp_init_aarch64(VP3DSPContext *c)
{
