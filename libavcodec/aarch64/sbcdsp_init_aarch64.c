...
/**
 * @file
 * SBC AArch64 NEON initialization
 */
...
/* Global arrays referenced by assembly (mirrored from arm/sbcdsp_init_arm.c) */
...
av_cold void ff_sbcdsp_init_aarch64(SBCDSPContext *s)
{
