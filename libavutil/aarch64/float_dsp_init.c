...
void ff_vector_dmul_neon(double *dst, const double *src0, const double *src1,
                         int len);

void ff_vector_dmac_scalar_neon(double *dst, const double *src, double mul,
                                int len);

double ff_scalarproduct_double_neon(const double *v1, const double *v2,
                                    size_t len);
...
av_cold void ff_float_dsp_init_aarch64(AVFloatDSPContext *fdsp)
{
    ...
    if (have_neon(cpu_flags)) {
        ...
        fdsp->scalarproduct_double = ff_scalarproduct_double_neon;
        fdsp->vector_dmac_scalar   = ff_vector_dmac_scalar_neon;
        fdsp->vector_dmul          = ff_vector_dmul_neon;
